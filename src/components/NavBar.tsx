...
const NavBar = () => {
  return (
    <div className="flex bg-slate-900 text-slate-100 text-md md:text-xl font-primary md:pl-2 flex-row justify-between cursor-pointer h-12 border-b border-slate-800 absolute w-full top-0">
